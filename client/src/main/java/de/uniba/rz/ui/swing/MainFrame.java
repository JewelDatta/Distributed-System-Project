...
public class MainFrame extends JFrame implements Observer {
    ...
    private JPanel createSearchPanel() {
        ...
        JTextField offsetField = new JTextField("1");
        ...
        searchButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int offset = 1;
                int limit = 10;
                if(!StringUtil.isNullOrEmpty(offsetField.getText())){
                    offset = Integer.parseInt(offsetField.getText());
                }
                if(!StringUtil.isNullOrEmpty(limitField.getText())){
                    limit = Integer.parseInt(limitField.getText());
                }

                controller.searchTicket(searchField.getText(),
