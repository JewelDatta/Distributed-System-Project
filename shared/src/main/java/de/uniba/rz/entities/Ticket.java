...
public class Ticket implements Serializable {
	...
	private static final long serialVersionUID = -6979364632920616223L;
	...
	public Ticket(String reporter, String topic, String description, Type type, Priority priority,Status status) {
		super();
		this.reporter = reporter;
		this.topic = topic;
		this.description = description;
